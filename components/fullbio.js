		...
		<div className="md:min-h-screen bg-blue">
			...
			<div className="p-5 max-w-prose mx-auto">
				...
				<h2 className="mb-8 font-serif font-bold text-2xl lg:text-3xl">
					<span className="md:hidden">About </span>Dave Cutter{" "}
				...
				<p className="mt-5 mb-10 text-lg leading-relaxed max-w-prose">
					...
					Photoshop. (A.C.E.) In my free time I study the History &amp;
					Philosophy of Science and International Politics at the University of
					Melbourne.
				</p>
				<p className="mt-5 mb-10 text-lg leading-relaxed max-w-prose">
					<strong>Dev Highlights:</strong> HTML, CSS, Javascript, React, Node,
					Angular, Vue, PHP, XML/XSLT, JQuery, VbScript, & Coldfusion
				</p>
				<p className="mt-5 mb-10 text-lg leading-relaxed max-w-prose">
