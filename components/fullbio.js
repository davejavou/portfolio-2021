...
export default function FullBio() {
  return (
    <div className="h-full bg-blue-500">
      <img src="/images/at-work.jpg" className="object-cover w-full max-h-96 mx-auto my-5 shadow-xl" alt="Candid at the water cooler" />
      <div className="p-5 max-w-prose mx-auto">
        <h2 className="my-5 font-serif font-bold text-white text-3xl md:text-2xl lg:text-3xl">
          Designer &amp; FE Developer
        </h2>
        <p className="mt-5 mb-10 text-white text-lg">
